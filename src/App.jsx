        ...
        <div className="navbar-container">
          ...
          <button className="whatsapp-btn" onClick={handleWhatsApp} title="Contactar por WhatsApp">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
              <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.67-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.076 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421-7.403h-.004c-2.759 0-5.412 1.138-7.382 3.109-1.97 1.971-3.055 4.624-3.055 7.382 0 5.684 4.626 10.31 10.31 10.31h.001c1.921 0 3.788-.509 5.443-1.48l.054-.031 5.582 1.462-1.482-5.41.032-.054c1.078-1.797 1.648-3.848 1.648-5.887 0-5.684-4.626-10.31-10.31-10.31" fill="currentColor"/>
              <path fill="currentColor" d="M23.992 0H.008C.003 0 0 .003 0 .008v23.984C0 23.997.003 24 .008 24h23.984c.005 0 .008-.003.008-.008V.008C24 .003 23.997 0 23.992 0z" opacity="0"/>
            </svg>
          </button>
        </div>
      </nav>
